...
export default function SocialShare() {
  ...
  return (
    <div className='conatainer mx-auto p-4 max-w-4xl'>
      <h1 className='text-3xl font-bold mb-6 text-center'>Social Media Image Creater</h1>
      <div className='card'>
        <div className='card-body'>
          <h2 className='card-title mb-4'>Upload an Image </h2>
          <div className='form-cnotrol'>
          ...
          {uploadedImage && (
            <div className='mt-6'>
              ...
              <div className='card-actions justofy-end mt-6'>
